...
namespace FixFactorSystem.Controllers
{
    public class AspNetUserRolesController : Controller
    {
        ...
        public AspNetUserRolesController(PhoneShopContext context)
        {
            _context = context;
        }
        ...
        {
            var phoneShopContext = _context.AspNetUserRoles.Include(a => a.Role).Include(a => a.User);
        ...
        public async Task<IActionResult> Create([Bind("UserId,RoleId,Note")] AspNetUserRoles aspNetUserRoles)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("UserId,RoleId,Note")] AspNetUserRoles aspNetUserRoles)
        {
